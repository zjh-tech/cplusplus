 ...
 * @Descripttion: 
 * @Author: zhengjinhong
 * @Date: 2020-01-21 15:58:14
 * @LastEditors: zhengjinhong
 * @LastEditTime: 2020-12-22 14:53:04
 */
...
public:
  ...
  static bool IsDirExist(const string& dir_path) {
#if defined(__linux__)
  ...
  static void TimeStamp2Tm(time_t timestamp, struct tm& tm) {
